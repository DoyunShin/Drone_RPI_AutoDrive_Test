...
if __name__ == '__main__':
    ...
    while True:
        ...
        if face_recog.isEnabled_recog:
            frame = face_recog.get_frame()
        else:
            frame = face_recog.get_frame_raw()
        ...
        # 인식된 얼굴 이 있다면
        if len(face_recog.face_locations) > 0 and face_recog.isEnabled_recog:
            print(face_recog.face_locations)
            face_recog.save_frame_to_image()
            face_recog.isEnabled_recog= False
